...
class TestExtractScrewListEdgeCases(unittest.TestCase):
    ...
    def test_1d_omega_1d_r(self) -> None:
    ...
    def test_single_joint_1d(self) -> None:
    ...
    def test_empty_r_list(self) -> None:
    ...
    def test_broadcast_r_single_col(self) -> None:
    ...
    def test_broadcast_omega_single_col(self) -> None:
...
class TestRotationMatrixToEulerGimbalLock(unittest.TestCase):
    ...
    def test_gimbal_lock(self) -> None:
