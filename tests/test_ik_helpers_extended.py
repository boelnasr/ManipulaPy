...
class TestWorkspaceHeuristicBranches(unittest.TestCase):
    ...
    def test_4_joints_normal(self) -> None:
    ...
    def test_6_joints_gimbal_lock(self) -> None:
    ...
    def test_xy_at_origin(self) -> None:
...
class TestClipToLimits(unittest.TestCase):
    ...
    def test_theta_longer_than_limits(self) -> None:
    ...
    def test_limits_longer_than_theta(self) -> None:
...
class TestIKInitialGuessCacheExtended(unittest.TestCase):
    ...
    def test_get_nearest_with_residual(self) -> None:
    ...
    def test_get_nearest_high_quality_direct_return(self) -> None:
    ...
    def test_get_nearest_averaging(self) -> None:
    ...
    def test_get_nearest_no_joint_limits(self) -> None:
...
class TestAdaptiveMultiStartIK(unittest.TestCase):
    ...
    def test_exception_in_solver(self) -> None:
    ...
    def test_all_exceptions_returns_zeros(self) -> None:
