...
<img src="docs/source/_static/gifs/ee_path.gif" alt="UR5 end-effector tracing a quintic-timed trajectory in 3D" width="540">
...
All three GIFs are regenerated by [`scripts/record_readme_gifs.py`](scripts/record_readme_gifs.py) from the current API — re-run after a release to keep the visuals in sync.
